...
Gist
 ...
 Watch 490
  Star 9,765
  Fork 7,956 DefinitelyTyped/DefinitelyTyped
 Code  Issues 1,154  Pull requests 158  Projects 1  Wiki  Pulse  Graphs
Tree: 2aac6c6f50 Find file Copy pathDefinitelyTyped/angularjs/angular.d.ts
2aac6c6  on May 21, 2015
@ejmarino ejmarino added $setDirty method to INgModelController (added in v1.3.15+)
79 contributors @basarat @johnnyreilly @vvakame @pocesar @michelsalib @ngbrown @borisyankov @RupertAvery @park9140 @xt0rted @wereHamster @xi @santialbo @kostaad @DerAlbertCom @flyingmutant @scottmcarthur @nojaf @dmitri-gb @Diullei @benjaminjackman @audsKu @anchann @adidahiya @Xiot @5angel and others
RawBlameHistory    
Executable File  1677 lines (1491 sloc)  75.1 KB
